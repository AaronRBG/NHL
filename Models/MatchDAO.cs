...
namespace NHL.Models
{
    public class MatchDAO
    {
        ...
        public MatchDAO() 
        {
            ...
            {
                Match m = new Match((long)dt.Rows[i][0], (byte)dt.Rows[i][1], (byte)dt.Rows[i][2], (byte)dt.Rows[i][3], (byte)dt.Rows[i][4], (DateTime)dt.Rows[i][5], (byte)dt.Rows[i][6], (byte)dt.Rows[i][7], (byte)dt.Rows[i][8], (bool)dt.Rows[i][9]);
                aux.Add(m);
            }
            matches = aux;
        }
